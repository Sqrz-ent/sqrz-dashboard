-- Expose the Phase 1 review columns through the stats view the Boost page reads.
-- Appended after data_source; bc.id is the PK so the new columns are group-by safe.
